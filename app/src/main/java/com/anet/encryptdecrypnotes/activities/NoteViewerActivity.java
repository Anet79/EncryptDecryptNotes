...
import com.anet.encryptdecrypnotes.databinding.ActivityNoteViewerBinding;
...
//        noteEntity = (NoteEntity) getIntent().getSerializableExtra("note");
    ...
    private void initNoteViewer(int noteId) {
        NoteDatabase.getInstance(this).noteDao()
                ...
                .observe(this, note -> {
                    ...
                    binding.noteTitleText.setText(AESUtils.sendDecrypt(noteEntity.getNoteTitle()));
                    setMarkdownText();
                });
    }
    ...
    private void setMarkdownText() {
        ...
        final Node node = markwon.parse(AESUtils.sendDecrypt(noteEntity.getNoteDescription()));
